        ...
        <div className="relative bg-white/10 dark:bg-black/30 backdrop-blur-xl border border-white/20 rounded-[2rem] p-8 lg:p-10 shadow-[0_0_40px_rgba(16,186,65,0.15)] overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="mb-8">
              ...
              <p className="text-sm text-zinc-300">Enter your new password below.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-zinc-300 tracking-wide uppercase">New Password</label>
