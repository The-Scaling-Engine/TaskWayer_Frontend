        ...
        <div className="relative bg-white/60 dark:bg-black/30 backdrop-blur-xl border border-white/40 dark:border-white/20 rounded-[2rem] p-8 lg:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_0_40px_rgba(16,186,65,0.15)] overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="mt-8 text-center flex items-center justify-center">
              <Link to="/login" className="flex items-center gap-2 text-sm text-emerald-700 hover:text-emerald-800 dark:text-zinc-400 dark:hover:text-white transition-colors font-medium">
                Log in
              </Link>
            </div>
