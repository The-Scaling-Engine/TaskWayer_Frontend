        ...
        <div className="relative bg-white/10 dark:bg-black/30 backdrop-blur-xl border border-white/20 rounded-[2rem] p-8 lg:p-10 shadow-[0_0_40px_rgba(16,186,65,0.15)] overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="mb-8">
              ...
              <p className="text-sm text-zinc-300">Enter your email to receive a reset link.</p>
            </div>
            ...
            {!success ? (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Link
                  to="/login"
                  className="flex items-center justify-center w-full h-12 mt-4 rounded-full font-bold text-black text-sm lg:text-base tracking-wide
                    bg-gradient-to-r from-emerald-400 via-green-400 to-amber-200
                    hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(16,186,65,0.4)]
                    active:scale-[0.98]
            ...
            <div className="mt-8 text-center flex items-center justify-center">
              <Link to="/login" className="flex items-center gap-2 text-sm text-zinc-400 hover:text-white transition-colors font-medium">
                <ArrowLeft size={16} />
                Back to login
              </Link>
            </div>
