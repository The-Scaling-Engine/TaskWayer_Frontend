          ...
          <div className="relative z-10">
            ...
            <div className="mb-8">
              <h1 className="text-4xl font-bold mb-2">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 dark:from-amber-200 dark:via-yellow-400 dark:to-amber-500">
                  Reset
                </span>
              </h1>
              <p className="text-sm text-zinc-600 dark:text-zinc-300">Enter your email to receive a reset link.</p>
            </div>
            ...
            {/* Success handling */}
            {success && (
              <div className="mb-6 bg-emerald-500/10 border border-emerald-500/30 text-emerald-700 dark:text-emerald-200 rounded-xl px-4 py-3 text-sm">
                {success}
              </div>
            )}
            ...
            {!success ? (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Link
                  to="/login"
                  className="flex items-center justify-center w-full h-12 mt-4 rounded-full font-bold text-white dark:text-black text-sm lg:text-base tracking-wide
                    bg-gradient-to-r from-emerald-500 via-green-500 to-emerald-400 dark:from-emerald-400 dark:via-green-400 dark:to-amber-200
                    hover:scale-[1.02] shadow-[0_4px_14px_rgba(16,186,65,0.2)] dark:hover:shadow-[0_0_20px_rgba(16,186,65,0.4)]
                    active:scale-[0.98]
            ...
            <div className="mt-8 text-center flex items-center justify-center">
              <Link to="/login" className="flex items-center gap-2 text-sm text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white transition-colors font-medium">
                <ArrowLeft size={16} />
                Back to login
              </Link>
            </div>
