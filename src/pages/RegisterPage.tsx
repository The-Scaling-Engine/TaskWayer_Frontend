        ...
        <div className="relative bg-white/60 dark:bg-black/30 backdrop-blur-xl border border-white/40 dark:border-white/20 rounded-[2rem] p-8 lg:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_0_40px_rgba(16,186,65,0.15)] overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="mb-8">
              ...
              <p className="text-sm text-zinc-600 dark:text-zinc-300">Create your new account to continue.</p>
            </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-sm text-zinc-600 dark:text-zinc-400">
                ...
                <Link to="/login" className="text-emerald-700 hover:text-emerald-800 dark:text-emerald-300 dark:hover:text-emerald-200 font-semibold transition-colors">
                  Log in
                </Link>
              </p>
            </div>
